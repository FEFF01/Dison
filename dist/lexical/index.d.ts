...
declare let TOKEN_TYPES: Record<string, string | number>;
...
export { PRIOR_REGEXP_PUNCTUATORS_TREE, PUNCTUATORS_TREE, NUMERIC_KEYWORD_MAP, TOKEN_TYPE_MAP, TOKEN_TYPES };
